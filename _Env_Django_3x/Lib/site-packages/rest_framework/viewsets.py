...
class ReadUpdateModelViewSet(mixins.UpdateModelMixin,
                             mixins.ListModelMixin,
                             GenericViewSet):
    pass


class ReadUpdateCreateModelViewSet(mixins.CreateModelMixin,
                                   mixins.RetrieveModelMixin,
                                   mixins.UpdateModelMixin,
                                   mixins.ListModelMixin,
                                   GenericViewSet):
    """
    自定义默认api方法，剔除删除方法 `create()`, `retrieve()`, `update()`,`partial_update()`, and `list()` actions.
    """
    pass
